...
export default Joi.object({
  zone: Joi.string().min(1).max(1).required().messages({
  ...
  alley: Joi.string().min(3).max(3).required().messages({
  ...
  position: Joi.string().min(4).max(4).required().messages({
  ...
  lvl: Joi.string().min(1).max(1).required().messages({
  ...
  lvl_position: Joi.string().min(2).max(2).required().messages({
  ...
  location_type_name: Joi.string().max(5).required().messages({
